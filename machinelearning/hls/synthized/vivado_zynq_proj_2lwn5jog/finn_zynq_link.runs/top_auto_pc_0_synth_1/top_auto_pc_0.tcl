...
namespace eval ::optrace {
  variable script "/tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0.tcl"
...
read_ip -quiet /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1 -new_name top_auto_pc_0 -ip [get_ips top_auto_pc_0]]
...
if { [catch {
  file copy -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0.dcp /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0_stub.v /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0_stub.vhdl /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0_sim_netlist.v /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.runs/top_auto_pc_0_synth_1/top_auto_pc_0_sim_netlist.vhdl /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.ip_user_files/ip/top_auto_pc_0]} {
  catch { 
    file copy -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.v /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.ip_user_files/ip/top_auto_pc_0
  }
}

if {[file isdir /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.ip_user_files/ip/top_auto_pc_0]} {
  catch { 
    file copy -force /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.srcs/sources_1/bd/top/ip/top_auto_pc_0/top_auto_pc_0_stub.vhdl /tmp/finn_dev_sss/vivado_zynq_proj_2lwn5jog/finn_zynq_link.ip_user_files/ip/top_auto_pc_0
  }
}
